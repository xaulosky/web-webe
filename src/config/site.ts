...
// Proyectos destacados. El diseño trae los datos reales sólo del primero; el
// resto quedan con los "XX" del mockup.
// TODO: completar ficha de cada proyecto.
export const proyectos = [
  {
    nombre: 'BNP Paribas',
    numero: 23,
    proyecto: 'Edificio XX',
    ubicacion: 'Santiago',
    superficie: '2.300 m²',
    puestos: '185',
    alcance: 'Mobiliario e iluminación',
    arquitectura: 'XX Arquitectos',
    marcas: 'Novara · Trisoft',
    ano: '2025',
  },
  { nombre: 'Cencosud', numero: 24, proyecto: 'Edificio XX', ubicacion: 'Santiago', superficie: '—', puestos: '—', alcance: '—', arquitectura: '—', marcas: '—', ano: '—' },
  { nombre: 'Lockton', numero: 21, proyecto: 'Edificio XX', ubicacion: 'Santiago', superficie: '—', puestos: '—', alcance: '—', arquitectura: '—', marcas: '—', ano: '—' },
  { nombre: 'Aforo', numero: 25, proyecto: 'Edificio XX', ubicacion: 'Santiago', superficie: '—', puestos: '—', alcance: '—', arquitectura: '—', marcas: '—', ano: '—' },
  { nombre: 'the concept', numero: 26, proyecto: 'Edificio XX', ubicacion: 'Santiago', superficie: '—', puestos: '—', alcance: '—', arquitectura: '—', marcas: '—', ano: '—' },
  { nombre: 'LE Abogados', numero: 24, proyecto: 'Edificio XX', ubicacion: 'Santiago', superficie: '—', puestos: '—', alcance: '—', arquitectura: '—', marcas: '—', ano: '—' },
  { nombre: 'Empresa', numero: 25, proyecto: 'Edificio XX', ubicacion: 'Santiago', superficie: '—', puestos: '—', alcance: '—', arquitectura: '—', marcas: '—', ano: '—' },
  { nombre: 'Wachimin', numero: 21, proyecto: 'Edificio XX', ubicacion: 'Santiago', superficie: '—', puestos: '—', alcance: '—', arquitectura: '—', marcas: '—', ano: '—' },
] as const;
